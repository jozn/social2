...
import com.mardomsara.x.iconify.Spanny;
...
public class XIcon extends AppCompatTextView implements HasOnViewAttachListener {
	...
	String textStr = " ";
	IranFonts iranFonts;
	int iconColor = 0x7f0500bd;// getContext().getResources().getColor(R.color.text_black_4);
	int textColor = 0x7f0500bd;//getContext().getResources().getColor(R.color.text_black_4);
	int iconSpacePx = dpToPx(2);

	int textSizePx = dpToPx(16) ;
    ...
    private void init(Context context, AttributeSet attrs) {
		...
		try {
			...
			iconSizePx = a.getDimensionPixelSize(R.styleable.XIcon_xiconSize, dpToPx(24));
