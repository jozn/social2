...
//	EmojiconsPopup mEmojiconPopup;
	...
	protected static EmojiconGridView newInstance(Context context,Emojicon[] emojicons, OnEmojiconClickedListener that ,EmojiconRecents recents, boolean useSystemDefault) {
		EmojiconGridView grid = new EmojiconGridView(context,emojicons, recents, that);
